// <copyright file="FirePBrigadeController.cs" company="Hysoft">
// Copyright (c) Hysoft. All rights reserved.
// </copyright>
// <author>qipengfei</author>
// <date> 2017-08-23 </date>
// <summary>专业森林消防队业务服务</summary>
// <modify>
// 修改人：qipengfei
// 修改时间：yyyy-mm-dd
// 修改描述：
...
namespace FFireManage.Service
{
    ...
    /// 版本：1.1
    /// </remarks>
    public class FirePBrigadeController:BaseServiceControler<Fire_PBrigade>
    {
        /// <summary>
        /// 获取专业森林消防队列表
        /// </summary>
        ...
        /// 新增专业森林消防队
        /// </summary>
        /// <param name="entity">专业森林消防队实体</param>
        /// <remarks>
        /// 创建人：qipengfei
        /// 创建日期：2017-08-23
        /// 修改人：qipengfei
        ...
        /// 版本：1.1
        /// </remarks>
        public override void Add(Fire_PBrigade entity)
        {
            if (entity != null)
            {
        ...
        /// 版本：1.0
        /// </remarks>
        public override void Edit(Fire_PBrigade entity)
        {
            if (entity != null)
            {
                Dictionary<string, object> parameterDict = entity.ObjectToDict();
