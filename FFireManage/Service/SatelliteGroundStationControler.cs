// <copyright file="SatelliteGroundStationControler.cs" company="Hysoft">
// Copyright (c) Hysoft. All rights reserved.
// </copyright>
// <author>yiyue</author>
// <date> 2017-09-01 </date>
// <summary>卫星地面站服务</summary>
// <modify>
// 修改人：
// 修改时间：yyyy-mm-dd
// 修改描述：
...
namespace FFireManage.Service
{
    ...
    /// 版本：1.0
    /// </remarks>
    public class SatelliteGroundStationControler : BaseServiceControler<Fire_SatelliteGroundStation>
    {
        /// <summary>
        /// 获取地面卫星站列表
        /// </summary>
        ...
        /// 新增地面卫星站
        /// </summary>
        /// <param name="entity">地面卫星站实体</param>
        /// <remarks>
        /// 创建人：yiyue
        /// 创建日期：2017-09-01
        /// 修改人：
        ...
        /// 版本：1.0
        /// </remarks>
        public override void Add(Fire_SatelliteGroundStation entity)
        {
            if (entity != null)
            {
                Dictionary<string, object> parameterDict = entity.ObjectToDict();
                if(!parameterDict.ContainsKey("f"))
                    parameterDict.Add("f", 4261001);
        ...
        /// 版本：1.0
        /// </remarks>
        public override void Edit(Fire_SatelliteGroundStation entity)
        {
            if (entity != null)
            {
                Dictionary<string, object> parameterDict = entity.ObjectToDict();
                if (!parameterDict.ContainsKey("f"))
                    parameterDict.Add("f", 4262001);
