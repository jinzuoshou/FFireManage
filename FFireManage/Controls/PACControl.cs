...
namespace FFireManage.Controls
{
    public partial class PACControl : UserControl
    {
        ...
        public string LocalPac
        {
            ...
            set { this.m_LocalPac = value; }
        }

        public Label LabelProvince
        {
            get { return this.labelProvince; }
        }
        public Label LabelCity
        {
            get { return this.labelCity; }
        }
        public Label LabelCounty
        {
            get { return this.lableCounty; }
        }

        public ComboBox CbxProvince
        {
