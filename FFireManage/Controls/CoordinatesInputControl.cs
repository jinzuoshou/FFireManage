...
{
    public partial class CoordinatesInputControl : UserControl
    {
        ...
        public CoordinatesInputControl()
        {
            InitializeComponent();
        }
    ...
    public enum Units
    {
        DecimalDegrees = 0,            //十进制度
        DegreesDecimalMinutes = 1,   //度十进制分
        DegreeMinutesSeconds = 2     //度 分 秒
    }
}
